...
use  PGMB\Configuration\AdminConfiguration ;
use  PGMB\Configuration\BackgroundProcessConfiguration ;
use  PGMB\Configuration\ComponentConfiguration ;
use  PGMB\Configuration\EventManagementConfiguration ;
use  PGMB\Configuration\MetaboxConfiguration ;
use  PGMB\Configuration\NotificationManagerConfiguration ;
use  PGMB\Configuration\PostTypeConfiguration ;
use  PGMB\Configuration\ProxyAPIConfiguration ;
...
class Plugin
{
    ...
    public function init()
    {
        ...
        $this->container->configure( [
            ProxyAPIConfiguration::class,
            EventManagementConfiguration::class,
            NotificationManagerConfiguration::class,
            AdminConfiguration::class,
            BackgroundProcessConfiguration::class,
