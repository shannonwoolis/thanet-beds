...
<form name="checkout" method="post" class="flex flex-wrap w-full checkout woocommerce-checkout" action="<?php echo esc_url(wc_get_checkout_url()); ?>" enctype="multipart/form-data">
